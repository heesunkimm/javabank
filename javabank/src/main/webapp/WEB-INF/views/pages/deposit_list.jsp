...
<!-- s: content -->
    <section id="account_list" class="content">
        <div class="info_box bg_yellow">
	            ...
	            <div class="btn_box">
	                <button type="button" onclick="location.href='transfer?'">이체</button>
	            </div>
        </div>
            ...
            <ul class="account_list">
                ...
                <li class="account_items">
                    <div class="txt_box">
                        ...
                        <p class="account_name"></p>
                        <p class="account_meno font_darkgray"></p>
                        <p></p>
                    </div>
                    <div class="account_info">
                   	<%-- <c:choose>
					    <c:when test="${account.type eq '출금'}">
						    <p class="account_type font_red"></p>
	                        <p class="delta_amount font_red">
	                        	<fmt:formatNumber value="-" pattern="#,###"/>원
	                        </p>
					    </c:when>
					    <c:otherwise>
						    <p class="account_type font_blue"></p>
